...
public class Performance implements Serializable {
    ...
    public void setSuperremark(String superremark) {
        this.superremark = superremark == null ? null : superremark.trim();
    }
    ...
    public void setPersonnelremark(String personnelremark) {
        this.personnelremark = personnelremark == null ? null : personnelremark.trim();
    }

    public String getSuperresult() {
        return superresult;
    }

    public void setSuperresult(String superresult) {
        this.superresult = superresult == null ? null : superresult.trim();
    }

    public String getPersonnelresult() {
        return personnelresult;
    }

    public void setPersonnelresult(String personnelresult) {
        this.personnelresult = personnelresult == null ? null : personnelresult.trim();
    }
}