...
public class Client implements Serializable {
    ...
    public String getClientspell() {
        return clientspell;
    }

    public void setClientspell(String clientspell) {
        this.clientspell = clientspell == null ? null : clientspell.trim();
    }
    ...
    public void setClientclassify(String clientclassify) {
        this.clientclassify = clientclassify == null ? null : clientclassify.trim();
    }
    ...
    public void setClientdept(String clientdept) {
        this.clientdept = clientdept == null ? null : clientdept.trim();
    }
    ...
    public void setClientbank(String clientbank) {
        this.clientbank = clientbank == null ? null : clientbank.trim();
    }
