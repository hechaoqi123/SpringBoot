...
<form action="/task/addAll" method="post" class="formTaskflow" id="formflow">
...
<tbody>
<tr>
<td>&nbsp;步骤: <span id="mapping.dbf.procXSource">新增任务</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;责任人: <span id="mapping.dbf.responsorSource">李萌,</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;参与人: <span id="mapping.dbf.participantsSource"></span></td>
