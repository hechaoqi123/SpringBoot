		      ...
		      querytypelis:function(criteria){
		          ...
		          this.$http.post(url,{emulateJSON:true}).then(function(res){
		              ...
		              for(var i=0;i<array.length;i++){
		                 ...
		                 if(array[i].rtype=="年度"){
		                   this.AllCount+=1;
		                 }else if(array[i].rtype=="季度"){
		                   this.onJob+=1;
		                 }else if(array[i].rtype=="月度"){
		                   this.onTrial+=1;
		                 }else if(array[i].rtype=="周"){
		                   this.temporary+=1;
		                 }else if(array[i].rtype=="项目"){
		                   this.retire+=1;
		                 }else if(array[i].rtype=="其他"){
		                   this.dimission+=1;
		                 }
		              }
