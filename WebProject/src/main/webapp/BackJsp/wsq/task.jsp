...
<tbody>
 ...
 <a><img src="BackJsp/wsq/img/folder.png" border="0"> 我创建的计划 </a>
 <a ><img src="BackJsp/wsq/img/folder.png" border="0"> 我执行的计划  </a>
 </td>
</tr>
<tr id="dataCount">
<td style="padding:16px" class="treeOfNavigation">
  ...
  <tr>
   ...
   <tbody>
      <tr v-for="list in list">
         <td><a :href="'plan/planQuerys?id='+list.pid"><img src="BackJsp/wsq/img/userX0.gif" border="0">{{list.pname}}</a></td>
         <td>{{list.username}}</td>
         <td>{{list.deptName}}</td>
         <td>{{list.ksdate}}</td>
         <td>{{list.jsdate}}</td>
