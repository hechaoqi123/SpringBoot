  ...
  <head>
	...
	<body class="no-skin" style="background-image:url(../assets/img/bg1.jpg);background-position: -200px -100px;">
		<div id="con">
			...
			<div style="width: 82%;">
		        <iframe src="BackJsp/wsq/look.jsp" id="myIframe" name="right_main" frameborder="0" scrolling="no" width="100%" height="1100px"  style="background-color: #fff;"></iframe> 
			</div>
		</div>
 </body>
