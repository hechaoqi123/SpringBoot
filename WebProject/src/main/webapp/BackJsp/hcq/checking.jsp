...
<html>
 ...
 <TABLE  border="0" cellspacing="0" cellpadding="0">
      ...
      <span id="oWorkflowList1" style="margin-left:700px;"><button id="save" class="btn" style="padding:5px 20px;border:1px solid #E0E0E0;background:#FCFCFC;border-radius:3px;cursor: pointer "><b>+</b>出差申请</button></span>
                        </TD>
...
<script>
     $(function(){
     $("#save").click(function(){
        window.location.href="BackJsp/hcq/checkingApply.jsp"
     })
       var load=new Vue({
            el:'#app',
            data:{
