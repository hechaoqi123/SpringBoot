...
<html>
  ...
  <span id="oWorkflowList1"><button id="save" class="btn" style="padding:5px 20px;border:1px solid #E0E0E0;background:#FCFCFC;border-radius:3px;cursor: pointer "><b>+</b>离职申请</button></span></td></tr></tbody></table><br>
    <!-- 分类 -->
	<div id="colloaMenu2">
	  ...
	  <!--  <a id="ruz"  href="BackJsp/hcq/entryPosition.jsp">
	   ...
	   <a href="BackJsp/hcq/dimission.jsp" class="textHighlight">
...
<a :href="'Dimission/detailInfo/'+d.dimissionid">{{d.theme}}</a></td>
...
<script>
     $(function(){
     $("#save").click(function(){
        window.location.href="BackJsp/hcq/dimissionApply.jsp"
     })
       var load=new Vue({
            el:'#app',
            data:{
