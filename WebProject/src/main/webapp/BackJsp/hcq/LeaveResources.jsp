...
<html>
 ...
 <TABLE  border="0" cellspacing="0" cellpadding="0">
        ...
        <TR>
          <TD>
            <H1><img src="BackJsp/hcq/img/log.png"/><span style="margin-left:7px;">调休资源</span></H1>
          <button id="save" class="btn" style="position:absolute;right:10px;width:150px;margin-left:800px;padding:5px 20px;border:1px solid #E0E0E0;background:#FCFCFC;border-radius:3px;cursor: pointer "><b>+</b>上传</button>
           </TD>
      ...
      <A href="BackJsp/hcq/LeaveResources.jsp" class="textHighlight"><IMG 
...
<script>
     $(function(){
     $("#save").click(function(){
        window.location.href="BackJsp/hcq/LeaveResourceApply.jsp"
     })
       var load=new Vue({
            el:'#app',
            data:{
