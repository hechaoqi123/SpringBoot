...
<td id="dbf.subject" dbf.type="required">
  <input id="e.dbf.subject" name="theme" class="fieldEditable" value="请休假申请-李萌-1002007">
</td>
...
<td id="dbf.division" dbf.type="required!0,required" dbf.source="form.fieldSource.division" dbf.key="1000034">
   <INPUT id=e.dbf.subject name="dept" class=fieldEditable></td>
...
<div onkeypress="return event.keyCode!=13;" onblur="this.innerHTML=this.innerHTML.replace(/&lt;\/?.+?&gt;/g,&#39;&#39;);" id="e.dbf.time1" class="fieldEditable" contenteditable="true">&nbsp;</div></td>
...
<div style="padding:2px 10px;"><div style="float:right;"><a href="javaScript:" onclick="javaScript:windowOpen(&#39;../flow/view1.htm?703240&#39;);return false;">› 显示流程图</a></div>【处理过程】</div>
