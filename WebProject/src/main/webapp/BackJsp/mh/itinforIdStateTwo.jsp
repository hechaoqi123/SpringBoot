...
<table style="padding-left:50px;padding-top:50px;" id="lotab">
   		<tr>
   			<td style="float:left;border:0px solid #000;"><img src="../assets/images/customersLogo.png" style="float:left;margin-top:10px;"><h1 style="float:left;margin-left:10px;">完成的项目</h1></td>
		  ...
		  var page=new Vue({
		    ...
		    methods:{
		        execute:function(pageNumber){
		              var url = '/Itinfor/selectStateTwo';
