...
<style>
 ...
 <table style="padding-left:30px;padding-top:30px; " id="lotab">
   		<tr>
   			<td style="float:left;border:0px solid #000;"><img src="../assets/images/customersLogo.png" style="float:left;margin-top:10px;"><h1 style="float:left;margin-left:10px;">全部项目任务</h1></td>
   			<td style="float:right;margin-left:650px;">
   				<div style="float:right;height:36px;width:280px;border:1px solid #c0c0c0;border-radius:5px; background: -webkit-linear-gradient(#FFFFFF, #F5F5F5);"">
   					...
   					<a href="task/taskUserAdd" style="color:#a6a6a6;"><div style="float:left;height:37px;width:110px;border:1px solid #c0c0c0;border-left:0px;border-top:0px;border-bottom:0px;"><span style="float:left;margin-top:10px;margin-left:20px;"><b>+新增任务</b></span></div></a>
   					<a href="BackJsp/mh/taskDim.jsp" style="color:#a6a6a6;"><div style="float:left;height:37px;width:70px;border:1px solid #c0c0c0;border-left:0px;border-top:0px;border-bottom:0px;"><span style="float:left;margin-top:10px;margin-left:20px;"><b>查找</b></span></div></a>
...
<tbody id="tab1" style="font-size:12px;">
	<tr v-for="t in task">
		<td v-if="t.rwfl=='0'"><a :href="'task/selectTailedAll?tid='+ t.tid"><i style="color:orange;" ></i><img src="img/ico1.png" style="width:15;height:15;float:left;margin-left:2px;margin-top:0px;"> <span style="color:#cc0000">{{t.tname}}</span> </a></td>
		<td v-else><a :href="'task/selectTailedAll?tid='+ t.tid"><i style="color:#8ed646;" ></i><img src="BackJsp/hcq/img/ico2.png " style="width:15;height:15;float:left;margin-left:2px;margin-top:0px;"> <span style="color:#8ed646">{{t.tname}}</span> </a></td>
		<td>{{t.itemname}}</td>
		<td>{{t.username}}</td>
		<td>{{t.username}}</td>
		<td>{{t.ksdeta}}&nbsp;</td>
