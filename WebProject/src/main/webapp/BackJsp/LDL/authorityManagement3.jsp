...
<br>
	...
	<div id="bottomDiv">
		...
		<div id="bottomRightDiv">
				...
				<div id="myTbody">
					<ul class="myTbodyUl">
						<li class="myTbodyUlLi" v-for="Visitonemodile in Visitonemodiles" >
	                        <span v-on:click="boolF">{{Visitonemodile.mOneId}}</span>
							...
							<ul class="myTbodyUlLiUl" v-bind:class="Visitonemodile.mOneId" v-for="Visittwomodile in Visittwomodiles" v-if="bool">
								<li id="myTbodyUlLiUlLi" v-if="!(Visittwomodile.mOneId != Visitonemodile.mOneId)" class="ww" > 
