        ...
        <TBODY>
          ...
          <TR>
             ...
             dbf.key="0">
                 ...
                 <input type="text" style="height:20px;width:380px;margin:0;padding:0;border:0px" 
                  name="zsclassify"readonly="readonly" value="${list[0].zsclassify}" id="e.dbf.divisionSource">
              ...
              <TD id="dbf.keyInfo" colspan="3">
                <INPUT class="fieldEditable" readonly="readonly" id="e.dbf.keyInfo"value="${list[0].zslabel}"name="zslabel">
              </TD>
         </TR>
         <TR>
            ...
            <TD id="dbf.links" colspan="5" dbf.source="files">
              <DIV id="e.dbf.links">
               <input type="text" id="e.dbf.positionX"readonly="readonly" value="${list[0].zsauthor}" name="zsauthor"readonly="readonly" value="${CurrentUser.uname }"class="fieldEditable">
              </DIV>
            </TD>
         </TR>
          <TR>
            ...
            <TD id="dbf.links" colspan="5" dbf.source="files">
              <DIV id="e.dbf.links">
               <input type="text" id="e.dbf.positionX" readonly="readonly" name="zstheme"value="${list[0].zstheme}" class="fieldEditable">
              </DIV>
            </TD>
         </TR>
         <TR>
      ...
      cellpadding="0">
        <TBODY>
          <TR valign="top">
            ...
            dbf.type="html"> 
               <TEXTAREA class="fieldEditable" id="e.content" readonly="readonly" style="height: 300px;" dbf.type="htm"name="zscontext"value="${list[0].zscontext}">
