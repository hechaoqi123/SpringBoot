...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <form id="myform" action="/Chequeapply/savePlay" method="post">
...
<td><span id="mapping.dbf.procXSource">
  ...
  <input name="dutypeople" style="border:0px;" readonly="true"/>
...
<td>
  <input name="applyname" class="fieldEditable"/>
</td>
...
<td id="开票说明" colspan="5" dbf.type="" dbf.source="">
   <textarea id="e.开票说明" name="remark" class="fieldEditable" style="HEIGHT: 80px"></textarea>
</td></tr></tbody></table>
...
<td id="金额大写" dbf.type="" dbf.source="">
   <input id="capital" style="border:0px;" readonly="true" name="capital">
</td></tr>
<tr>
...
<div style="padding:2px 10px;"><div style="float:right;"><a href="javaScript:" onclick="javaScript:windowOpen(&#39;../flow/view1.htm?753310&#39;);return false;"></a></div>【处理过程】</div>
